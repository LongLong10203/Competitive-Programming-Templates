...
private:
    ...
    using node_allocator_t = typename allocator_traits<Allocator>::template rebind_alloc<node>;
    ...
    pnode create_node(T x) {
        ...
        allocator_traits<node_allocator_t>::construct(node_allocator_, place, x, next_priority());
        return place;
    }

    void destroy_node(pnode t) {
        allocator_traits<node_allocator_t>::destroy(node_allocator_, t);
